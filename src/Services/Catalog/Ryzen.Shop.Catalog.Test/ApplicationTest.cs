    ...
    public  class ApplicationTest
    {
        ...
        private List<Promotion> GetFakePromotions()
        {
            ...
            new()
            {
                PromotionID = 1,
                Name = "fakePromotionA",
                Type = PromotionType.DiscountAmount,
                DiscountAmount = 10,
                DiscountPercentage = 0,
                MinimumSpendDiscountAmount = 0,
            ...
            new()
            {
                PromotionID = 2,
                Name = "fakePromotionB",
                Type = PromotionType.DiscountPercentage,
                DiscountAmount = 0,
            ...
            new()
            {
                PromotionID = 3,
                Name = "fakePromotionC",
                Type =PromotionType.TrollyDiscountPercentage,
                DiscountAmount = 0,
                DiscountPercentage = 0,
                MinimumSpendDiscountAmount = 10,
